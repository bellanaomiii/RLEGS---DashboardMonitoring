...
<style>
    ...
    .view-mode-btn.active {
        background: linear-gradient(to right, #0e223e, #1e3c72);
        color: white;
        box-shadow: 0 2px 8px rgba(28, 41, 85, 0.3);
    ...
    /* Table Styling - IMPROVED FOR MOBILE */
    .table-responsive {
        overflow-x: auto;
    ...
    .customer-name {
        font-weight: 600;
        color: #1C2955;
        min-width: 200px; /* Ensure customer name has enough space */
    }
    ...
    /* Responsive Adjustments - IMPROVED MOBILE RESPONSIVENESS */
    ...
    @media (max-width: 992px) {
        ...
        /* IMPROVED: Better table handling on tablet */
        .data-table {
            min-width: 700px;
        }
    }
    ...
    @media (max-width: 768px) {
        ...
        /* IMPROVED: Better tab navigation on mobile */
        .tab-button:first-child {
            border-top-right-radius: 15px;
        }
        ...
        /* IMPROVED: Mobile table responsiveness - horizontal scroll */
        .table-responsive {
            border-radius: 8px;
        ...
        .data-table {
            min-width: 650px; /* Reduced minimum width for mobile */
            font-size: 14px;
        }
    ...
    @media (max-width: 576px) {
        ...
        /* IMPROVED: Ultra mobile table handling */
        .data-table {
            min-width: 550px; /* Further reduced for very small screens */
            font-size: 13px;
        }
